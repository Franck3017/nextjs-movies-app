  ...
  useEffect(() => {
    ...
    const fetchPopularData = async () => {
      try {
        ...
        // Fetch popular items
        const itemsUrl = `/api/${type}/popular?page=${currentPage}&sort_by=${sortBy}&sort_order=${sortOrder}`
        ...
        showNotification({
          type: 'error',
          title: 'Error',
          message: 'No se pudieron cargar los datos de tendencias'
        })
      } finally {
        setLoading(false)
      }
      ...
      <Layout>
        <div className="min-h-screen flex items-center justify-center px-4">
          <div className="text-center max-w-md">
            <h1 className="text-xl sm:text-2xl font-bold text-cineRed mb-3 sm:mb-4">Error al cargar las tendencias</h1>
  ...
  return (
    <Layout>
      <div className="min-h-screen">
        {/* Header - Responsive */}
        <div className="bg-gradient-to-r from-orange-500/20 to-red-600/20 backdrop-blur-sm border-b border-orange-500/30">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 lg:py-8">
            ...
            >
              ...
              <div className="flex items-center gap-3 sm:gap-4">
                <motion.div
                  className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-orange-500 to-red-600 rounded-2xl flex items-center justify-center shadow-lg"
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-sm sm:text-base">
                    {type === 'movies' ? 'Películas' : 'Series'} más populares del momento
                  </p>
                </div>
              </div>
            </motion.div>
